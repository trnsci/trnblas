...
Capture `instance_id` from the outputs. User-data takes ~5 minutes to install the Neuron SDK and clone trnblas.
...
1. Look up the tagged instance (`Name=trnblas-ci-trn1` by default)
